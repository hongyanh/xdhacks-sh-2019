 //创建和初始化地图函数：
    ...
    function createMap(){
        ...
        var point = new BMap.Point(121.521934,31.221601);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"",content:"",point:"121.480827|31.239387",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
